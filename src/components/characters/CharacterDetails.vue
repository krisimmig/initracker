  ...
  >
    <perfect-scrollbar >
      <div class="CharacterDetails-title">
        ...
        <v-card-subtitle class="caption pb-1">{{ getDescription() }} - {{ characterData.category }}</v-card-subtitle >
      </div >
      ...
      <div class="body-2 text--primary pa-4">
        ...
        <div class="d-flex">
          ...
          <div class="d-flex align-center ml-6">
            ...
            <p
                class="mb-0 ml-2"
                v-if="characterData.armor_desc"
            >{{ characterData.armor_desc }}</p >
            <p
        ...
        <p class="mb-1">
          ...
          {{ characterData.damage_vulnerabilities || "&mdash;" }}
        </p >
      </div >

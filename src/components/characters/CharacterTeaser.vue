<template>
  <div v-if="characterData">
    ...
    <div class="d-flex items-end w-full p-2 pt-0 justify-between items-center">
      <div class="d-flex text-gray-600 font-light text-sm">
        <div class="mr-4 d-flex items-center">
